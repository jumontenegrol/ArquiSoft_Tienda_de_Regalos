      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6">
        {productos.map((p: any) => (
          <Link href={`/producto/${p.id}`} key={p.id}
            className="bg-white shadow-md rounded-xl overflow-hidden hover:scale-105 transition-transform duration-200 cursor-pointer block">
            {/* Client image component handles onError in the browser */}
            <ImageWithFallback
            ...
            <div className="p-4">
              ...
              <ExternalAnchor href={`https://wa.me/573005554942?text=Hola!%20Estoy%20interesado%20en%20${encodeURIComponent(p.nombre)}`}
